    ...
    <div className="min-h-dvh px-4 py-6 sm:px-6 md:px-8">
      <div className="grid grid-cols-1 gap-4">
        ...
        >
          ...
          <div className="mt-2 text-white/70 text-sm">신청/참여/완료한 스터디</div>
        </Link>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-white text-lg">개설된 스터디</span>
            <span className="text-white/70">→</span>
          </div>
          <div className="mt-2 text-white/70 text-sm">현재 진행 중인 스터디를 둘러보세요</div>
        </Link>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-white text-lg">동아리방 도서</span>
            <span className="text-white/70">→</span>
          </div>
          <div className="mt-2 text-white/70 text-sm">대여 가능한 책을 확인하세요</div>
        </Link>
        ...
        >
          <div className="flex items-center justify-between">
            <span className="text-white text-lg">내 정보 및 설정</span>
            <span className="text-white/70">→</span>
          </div>
        </Link>
        {isLoggedIn && (
